    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?php echo base_url(); ?>/assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="post" action="<?php echo base_url(); ?>auth/register_process">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Name" name="name"> </div>
                        </div>
                        <div class="form-group ">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Already have an aaccount? <a href="<?php echo base_url(); ?>auth/login" class="text-info m-l-5"><b>Login</b></a>
                            </div>
                        </div>
                    </form>
